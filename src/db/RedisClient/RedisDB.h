...
#define redis_string_list_add(sl,str)   sl.push_back(str)
...
//		typedef MapObject<string,HashsItem> redis_hashs_item_list;
		...
		public:	//有序集合
            ...
            int64 ZAdd(const char *,int64,const char *);												///<添加一个元素到有序集合
            int64 ZAdd(const char *,int,int64 *,const char **);										///<添加多个元素到有序集合
